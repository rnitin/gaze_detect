...
save_path = "../assets/models/gazenet_gh_lenet.pt" # save path for trained model
...
class GazeNet(nn.Module): # LeNet based model
    def __init__(self):
        ...
        self.fc1 = nn.Linear(6*12*50, 500)  # from maxpool2 dimension
        self.reg = nn.Linear(503,2) # regression layer
        self.float()
